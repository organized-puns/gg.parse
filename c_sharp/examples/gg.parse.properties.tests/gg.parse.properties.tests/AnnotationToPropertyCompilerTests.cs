    ...
    public class AnnotationToPropertyCompilerTests
    {
        ...
        public void SetupIntAnnotation_CallInterpret_ExpectIntValue()
        {
            ...
            var result = new AnnotationToPropertyCompiler()
                            .Compile<int>(intAnnotation, new PropertyContext(text, tokens, [intAnnotation]));
        ...
        public void SetupStringAnnotation_CallInterpret_ExpectIntValue()
        {
            ...
            // act
            var context = new PropertyContext(text, tokens, [stringAnnotation], true);
        ...
        public void SetupKvpAnnotation_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            var context = new PropertyContext(text, tokens, [kvpList], true);

            // act
            var result = annotationCompiler.Compile<Dictionary<string, object>>(kvpList, context);
        ...
        public void SetupEmptyDictionary_CallInterpret_ExpectNull()
        {
            ...
            // act
            var result = annotationCompiler.Compile(null, dictionaryAnnotation, context);
        ...
        public void SetupMetaInformation_CallInterpret_ExpectDefaultObject()
        {
            ...
            var (_, annotationCompiler) = PropertyCompilers.CreateCompilers();
            var context = new PropertyContext(text, tokens.Annotations, syntaxTree.Annotations, true);
        ...
        public void SetupDictionaryAnnotation_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            var context = new PropertyContext(text, tokens, [dictionary], true);
            var (_, annotationCompiler) = PropertyCompilers.CreateCompilers();

            // act
            var result = annotationCompiler.Compile<Dictionary<int, bool>>(dictionary, context);
        ...
        public void ParseDictionary_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            // act
            var result = annotationCompiler.Compile<Dictionary<int, bool>>(syntaxTree[0], context);
        ...
        {
            // setup
            var text = "// autogenerated property file\r\nproperty.type: \"gg.parse.properties.tests.testclasses.ComplexProperties, gg.parse.properties.tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\"\r\nName: \"foo\"\r\nExtendedProperties: {\r\n  \"key1\": \"value1\",\r\n  \"key2\": \"value2\"\r\n}\r\nArr: [1, 2, 3]\r\nSingleProperty: {\r\n  property.type: \"gg.parse.properties.tests.testclasses.SingleProperty, gg.parse.properties.tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\"\r\n  Name: \"foo\"\r\n}\r\nBoolList: [true, false, true]\r\nStringSet: null";
        ...
        [TestMethod]
        public void ParseObjectWithMetaDataDontAllowUnmanagedTypes_CallInterpret_ExpectComplexArgumentException()
        {
            // setup
            var text = "// autogenerated property file\r\nproperty.type: \"gg.parse.properties.tests.ComplexProperties, gg.parse.properties.tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\"\r\nName: \"foo\"\r\nExtendedProperties: {\r\n  \"key1\": \"value1\",\r\n  \"key2\": \"value2\"\r\n}\r\nArr: [1, 2, 3]\r\nSingleProperty: {\r\n  _type: \"gg.parse.properties.tests.testclasses.SingleProperty, gg.parse.properties.tests, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\"\r\n  Name: \"foo\"\r\n}\r\nBoolList: [true, false, true]\r\nStringSet: null";
            var (tokens, syntaxTree) = PropertyParser.Parse(text);

            // context by default doesn't allow unmanaged types, ie types that are
            // not in the allowed list
            var context = new PropertyContext(text, tokens.Annotations, syntaxTree.Annotations);
            var (_, annotationCompiler) = PropertyCompilers.CreateCompilers();

            // act
            annotationCompiler.Compile<ComplexProperties>(syntaxTree[0][0], context);

            IsTrue(context.Logs.Contains(LogLevel.Error));
        }
        ...
        {
            // setup
            var text = "// autogenerated property file\r\nproperty.type: \"ComplexProperties\"\r\nName: \"foo\"\r\nExtendedProperties: {\r\n  \"key1\": \"value1\",\r\n  \"key2\": \"value2\"\r\n}\r\nArr: [1, 2, 3]\r\nSingleProperty: {\r\n  property.type: \"SingleProperty\"\r\n  Name: \"foo\"\r\n}\r\nBoolList: [true, false, true]\r\nStringSet: null";
            var (tokens, syntaxTree) = PropertyParser.Parse(text);
        ...
        public void ParseObjectWithoutMetaDataInJsonFormat_CallInterpret_ExpectObjectDictionary()
        {
            ...
            // act
            var result = annotationCompiler.Compile<Dictionary<string, object>>(syntaxTree[0][0], context);
        ...
        public void ParseObjectEnumDictionary_CallInterpret_ExpectEnumDictionary()
        {
            ...
            var (tokens, syntaxTree) = PropertyParser.Parse(text);
            var (_, annotationCompiler) = PropertyCompilers.CreateCompilers();
            var context = new PropertyContext(text, tokens.Annotations, syntaxTree.Annotations, new TypePermissions(typeof(TestEnum)));

            // act
            var result = annotationCompiler.Compile<Dictionary<string, TestEnum>>(syntaxTree[0][0], context);
