    ...
    public class AnnotationToPropertyCompilerTests
    {
        ...
        public void SetupKvpAnnotation_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                            .Compile<Dictionary<string, object>>(kvpList, context);
        ...
        public void SetupEmptyDictionary_CallInterpret_ExpectNull()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                            .Compile(null, dictionaryAnnotation, context);
        ...
        public void SetupDictionaryAnnotation_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                            .Compile<Dictionary<int, bool>>(dictionary, context);
        ...
        public void ParseDictionary_CallInterpret_ExpectStringObjectDictionary()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                    .Compile<Dictionary<int, bool>>(syntaxTree[0], context);
        ...
        public void ParseObjectWithoutMetaDataInJsonFormat_CallInterpret_ExpectObjectDictionary()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                    .Compile<Dictionary<string, object>>(syntaxTree[0][0], context);
        ...
        public void ParseObjectWithoutMetaDataInDefaultFormat_CallInterpret_ExpectObjectDictionary()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler).Compile<Dictionary<string, object>>(syntaxTree[0][0], context);
        ...
        public void ParseObjectEnumDictionary_CallInterpret_ExpectEnumDictionary()
        {
            ...
            // act
            var result = new AnnotationToPropertyCompiler(typeCompiler)
                            .Compile<Dictionary<string, TestEnum>>(syntaxTree[0][0], context);
