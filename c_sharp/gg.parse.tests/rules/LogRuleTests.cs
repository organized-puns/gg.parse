...
namespace gg.parse.tests.rules
{
    ...
    public class LogRuleTests
    {
        ...
        {
            var logRule = new LogRule<char>("log", IRule.Output.Self, "description");
        ...
        public void CreateLogRuleWithLiteralCondition_Parse_ShouldMatchLiteral()
        {
            ...
            var logRule = new LogRule<char>("log", IRule.Output.Self, "description", matchFoo, LogLevel.Error);
        ...
        {
            var matchFoo = new MatchDataSequence<char>("matchFoo", "foo".ToCharArray());
            var logRule = new LogRule<char>("log", IRule.Output.Self, "description", matchFoo, LogLevel.Fatal);
