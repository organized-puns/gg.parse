...
namespace gg.parse.argparser.tests
{
    ...
    public class AnnotationToPropertyCompilerTests
    {
        ...
        private static readonly IRule arrayRule = new EmptyRule(PropertyFileNames.Array);
        private static readonly IRule arrayStart = new EmptyRule(PropertyFileNames.ArrayStart);
        private static readonly IRule arrayEnd = new EmptyRule(PropertyFileNames.ArrayEnd);
        ...
        public void SetupIntAnnotation_CallInterpret_ExpectIntValue()
        {
            ...
            var result = new AnnotationToPropertyCompiler()
                            .Compile<int>(intAnnotation, new CompileContext(text, tokens));
        ...
        public void SetupStringAnnotation_CallInterpret_ExpectIntValue()
        {
            ...
            // act
            var context = new CompileContext(text, tokens);
        ...
        public void SetupEmptyDictionary_CallInterpret_ExpectNull()
        {
            ...
            // act
            var context = new CompileContext(null, tokens);
        ...
        public void SetupMetaInformation_CallInterpret_ExpectDefaultObject()
        {
            ...
            // act
            var context = new CompileContext(text, tokens.Annotations);
            var result = new AnnotationToPropertyCompiler()
